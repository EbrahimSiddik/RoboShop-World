...
<body>
  <div class="container-scroller">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text"><span class="text-black fw-bold">Admin </span>Dashboard</h1>
          </li>
        </ul>
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                ...
                <p class="fw-light text-muted mb-0">support@admin.com</p>
              </div>
              <a class="dropdown-item"><i class="dropdown-item-icon mdi mdi-account-outline text-primary me-2"></i>Home</a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar" style="width: 150px;">
        <ul class="nav">
          <li class="nav-item">
                                  ...
                                  <table class="table select-table">
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex ">
                                            <img src="{{asset('dashboard/images/faces/face1.jpg')}}" alt="">
                                            <div>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <img src="{{asset('dashboard/images/faces/face2.jpg')}}" alt="">
                                            <div>
                                              <h6>Laura Brooks</h6>
                                              <p>Head admin</p>
                                            </div>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <img src="{{asset('dashboard/images/faces/face3.jpg')}}" alt="">
                                            <div>
                                              <h6>Wayne Murphy</h6>
                                              <p>Head admin</p>
                                            </div>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <img src="{{asset('dashboard/images/faces/face4.jpg')}}" alt="">
                                            <div>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <img src="{{asset('dashboard/images/faces/face5.jpg')}}" alt="">
                                            <div>
